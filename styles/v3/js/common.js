...
var Method = {
    Element: function () {
        ...
        this.getValue = function () {
            if (this.value === undefined) return this.innerHTML; else return this.value;
        };
        this.setValue = function (s) {
            if (this.value === undefined) this.setInnerHTML(s); else this.value = s;
        };
        ...
        this.nextElement = function () {
            var n = this;
            for (var i = 0, n; n = n.nextSibling; i++) if (n.nodeType == 1) return GetObjcet(n);
            return null;
        };
        this.previousElement = function () {
            var n = this;
            for (var i = 0, n; n = n.previousSibling; i++) if (n.nodeType == 1) return GetObjcet(n);
            return null;
        };
        ...
        this.getStyle = function (name) {
            if (this.style[name]) return this.style[name]; else if (this.currentStyle) return this.currentStyle[name]; else if (document.defaultView && document.defaultView.getComputedStyle) {
        ...
        this.setInnerHTML = function (s) {
            ...
            if (ua.indexOf('msie') >= 0 && ua.indexOf('opera') < 0) {
                ...
                this.innerHTML = s;
                if (el_next) el_parent.insertBefore(this, el_next); else el_parent.appendChild(this);
            }
        };
...
var Ajax = {
    Request: function (vname, vars) {
        ...
        var param = {
            method: "", parameters: "", asynchronous: true, onLoading: function () {
            }, onLoaded: function () {
...
function anr() {
    if (navigator.userAgent.indexOf('Android') > -1) {
        document.writeln("<div class=\'apptip\'><a href=\'https://cdn.a.zw.yodu.app/\'><i class=\'icon-app-logo\'><svg class=\'icon icon-qi\'><use xlink:href=\'#i-logo\'></use></svg></i><h3 class=\'apptip-h\'>安装 有度中文 客户端</h3><p class=\'apptip-p\'>更方便的阅读图书小说</p><span class=\'btn-primary-small\'>下载</span></a></div>");
    } else {
    }
}
